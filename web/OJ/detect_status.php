...
if($can_detect_bugs == false){
    $view_errors= "";
    require("template/".$OJ_TEMPLATE."/error.php");
    exit(0);
}
//get try times and determine if he can detect bugs END
...
/////////////////////////Template
if (isset($_GET['cid']))
    require("template/".$OJ_TEMPLATE."/contest_detect_status.php");
else
    require("template/".$OJ_TEMPLATE."/detect_status.php");
/////////////////////////Common foot
